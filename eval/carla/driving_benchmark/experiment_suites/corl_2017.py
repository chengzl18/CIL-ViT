...
class CoRL2017(ExperimentSuite):
    ...
    def train_weathers(self):
        return [] # do not test any train weather

    @property
    def test_weathers(self):
        # Demo Video modification 3
        # return [14]
        return [4, 14]
    ...
    def _poses_town02(self):
        ...
        def _poses_navigation():
            # return [[51,81],[51,81]] # Demo Video modification 1                   [19, 66], [79, 14], [19, 57], [23, 1],
            return [[53, 76], [42, 13], [31, 71], [33, 5],
                    [54, 30], [10, 61], [66, 3], [27, 12],
                    [79, 19], [2, 29], [16, 14], [5, 57],
                    [70, 73], [46, 67], [57, 50], [61, 49], [21, 12],
                    [51, 81], [77, 68], [56, 65], [43, 54]]

        # do not test straight and one curve (too easy)
    ...
    def build_experiments(self):
        ...
        if self._city_name == 'Town01':
            ...
            # pedestrians_tasks = [0, 0, 0, 50]
            vehicles_tasks = [0, 15, 0, 0]
            pedestrians_tasks = [0, 50, 0, 0]
            # Demo Video modification 2
            # vehicles_tasks = [15, 0, 0, 15]
            # pedestrians_tasks = [50, 0, 0, 50]
